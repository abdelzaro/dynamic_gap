    ...
    class TrajectoryEvaluator
    {
        public:
            ...
            */
            ...
            /**
            * \brief Function for evaluating high relative velocities near dynamic obstacles (e.g. humans)
            * \param relativeVel relative velocity between robot and dynamic obstacle
            */
